                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('new-category') }}" class="form-inline" enctype="multipart/form-data">
                                ...
                                <input type="text" name="focusKey" class="form-control mb-2 mr-sm-2" id="focusKey" placeholder="Focus Keyword" >
                                <br>
                                <label class="sr-only" for="metaKey">Meta Keyword</label>
                                <input type="text" name="metaKey" class="form-control mb-2 mr-sm-2" id="metaKey" placeholder="Meta Keyword" >
                                <br>
                                <label class="sr-only" for="metaTag">Meta Tag</label>
                                <input type="text" name="metaTag" class="form-control mb-2 mr-sm-2" id="metaKey" placeholder="Meta Tags" >
                                <br>
