    ...
    <div class="container-fluid pt-5">
        <div class="text-center mb-4">
            @foreach($categories as $category)
                @if($Brands->category_id == $category->id)
            <h2 class="section-title px-5"><span class="px-2"> {{$Brands->BrandName}} Brand All {{$category->CategoryName}}  Here</span></h2>
                @endif
            @endforeach
        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            <div
                                ...
                                <img class="img-fluid w-100" src="{{asset($product->image)}}" style="height: 300px; width: 150px;" alt="Brand Image">
                            </div>
